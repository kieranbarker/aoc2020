...
public class Program {
    ...
    private static boolean isMatch(String color, Map<String, Map<String, Integer>> parsed, Map<String, Boolean> memo) {
    ...
    private static List<String> readInput() {
        try (
                InputStream inputStream = Program.class.getClassLoader().getResourceAsStream("day07.txt");
